...
public class RobotContainer {
  ...
  private final CanVenomDriveBaseSubsystem canVenomDriveBaseSubsystem = new CanVenomDriveBaseSubsystem();
  ...
  private final ArcadeDrive arcadeDrive = new ArcadeDrive(joystick1, canVenomDriveBaseSubsystem, 0.6, 0.6);
  ...
  private void configureButtonBindings() {
    new JoystickButton(joystick1, XboxController.Button.kRightBumper.value)
      .whileTrue(new TurnWithAprilTag(visionSubsystem, canVenomDriveBaseSubsystem));
  ...
  public void setDefaultCommands() {
    ...
    canVenomDriveBaseSubsystem.setDefaultCommand(arcadeDrive);
  }
}
