...
import frc.robot.subsystems.windowmotorarm.RunWindowMotorArm;
import frc.robot.subsystems.windowmotorarm.WindowMotorArmSubsystem;
...
public class RobotContainer {
  ...
  private final WindowMotorArmSubsystem windowMotorArmSubsystem = new WindowMotorArmSubsystem();
  private final RunWindowMotorArm runWindowMotorArm = new RunWindowMotorArm(windowMotorArmSubsystem, joystick1);
  ...
  public void setDefaultCommands() {
    ...
    windowMotorArmSubsystem.setDefaultCommand(runWindowMotorArm);
  }
}
