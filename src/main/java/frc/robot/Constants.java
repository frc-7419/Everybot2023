  ...
  public static class SwerveConstants {
    ...
    */
    ...
    public static final SwerveModuleConstants frontLeft = new SwerveModuleConstants(
      2, 1, 9, 78.3, new Translation2d(RobotConstants.HALF_LENGTH, RobotConstants.HALF_LENGTH) );
    ...
    public static final SwerveModuleConstants backRight = new SwerveModuleConstants(
      6, 5,11, 305.533,  new Translation2d(-RobotConstants.HALF_LENGTH, -RobotConstants.HALF_LENGTH));
