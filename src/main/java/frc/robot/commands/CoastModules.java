...
public class CoastModules extends CommandBase {
  DriveBaseSubsystem driveBaseSubsystem;
  SwerveDriveFieldCentric swerveDriveFieldCentric;
  public CoastModules(DriveBaseSubsystem driveBaseSubsystem, SwerveDriveFieldCentric swerveDriveFieldCentric) {
