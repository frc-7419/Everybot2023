...
public class TwoPieceMidCone extends SequentialCommandGroup {
  public TwoPieceMidCone(DriveBaseSubsystem driveBaseSubsystem, ArmSubsystem armSubsystem, IntakeSubsystem intakeSubsystem, SwerveDriveFieldCentric swerveDriveFieldCentric, GroundIntakeSubsystem groundIntakeSubsystem) {
    addCommands(
      ...
      new ArmSetpointPID(armSubsystem, ArmConstants.midConeSetpoint).alongWith(new RunIntake(intakeSubsystem, 0.115)).withTimeout(2),
