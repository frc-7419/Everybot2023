...
public class TwoPieceMidCube extends SequentialCommandGroup {
  public TwoPieceMidCube(DriveBaseSubsystem driveBaseSubsystem, ArmSubsystem armSubsystem, IntakeSubsystem intakeSubsystem, SwerveDriveFieldCentric swerveDriveFieldCentric, GroundIntakeSubsystem groundIntakeSubsystem) {
    addCommands(
      ...
      new ArmSetpointPID(armSubsystem, ArmConstants.midCubeSetpoint).alongWith(new RunIntake(intakeSubsystem, 0.115)).withTimeout(2),
